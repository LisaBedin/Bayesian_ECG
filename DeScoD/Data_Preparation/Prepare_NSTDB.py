...
def prepare(NSTDBPath='/mnt/Reseau/Signal/lisa/ECG_data/mit-bih-noise-stress-test-database-1.0.0/'):
    ...
    # Save Data
    with open('/mnt/Reseau/Signal/lisa/ECG_data/DeScoD_data/NoiseBWL.pkl', 'wb') as output:  # Overwrites any existing file.
