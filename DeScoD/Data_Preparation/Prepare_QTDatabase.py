...
def prepare(QTpath='/mnt/Reseau/Signal/lisa/ECG_data/qt-database-1.0.0/'):
    ...
    for i in namesPath:
        ...
        auxSig = signal[0:qu, :]  #  keep both channels
    ...
    # Save Data
    with open('/mnt/Reseau/Signal/lisa/ECG_data/DeScoD_data/QTDatabase.pkl', 'wb') as output:  # Overwrites any existing file.
