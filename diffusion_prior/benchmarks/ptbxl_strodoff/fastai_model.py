...
from diffusion_prior.benchmarks.ptbxl_strodoff.timeseries_utils import *
from diffusion_prior.benchmarks.ptbxl_strodoff.resnet1d import resnet1d18,resnet1d34,resnet1d50,resnet1d101,resnet1d152,resnet1d_wang,resnet1d,wrn1d_22
from diffusion_prior.benchmarks.ptbxl_strodoff.xresnet1d import xresnet1d18,xresnet1d34,xresnet1d50,xresnet1d101,xresnet1d152,xresnet1d18_deep,xresnet1d34_deep,xresnet1d50_deep,xresnet1d18_deeper,xresnet1d34_deeper,xresnet1d50_deeper
from diffusion_prior.benchmarks.ptbxl_strodoff.inception1d import inception1d
from diffusion_prior.benchmarks.ptbxl_strodoff.basic_conv1d import fcn,fcn_wang,schirrmeister,sen,basic1d,weight_init
from diffusion_prior.benchmarks.ptbxl_strodoff.rnn1d import RNN1d
import math

from diffusion_prior.benchmarks.ptbxl_strodoff.base_model import ClassificationModel
import torch
...
from diffusion_prior.benchmarks.ptbxl_strodoff.utils import evaluate_experiment
...
class fastai_model(ClassificationModel):
    def __init__(self,name,n_classes,freq,outputfolder,
                 input_shape,pretrained=False,
                 input_size=2.5,input_channels=12,
                 chunkify_train=False,chunkify_valid=True,
                 bs=128,ps_head=0.5,lin_ftrs_head=[128],wd=1e-2,epochs=50,lr=1e-2,
                 kernel_size=5,loss="binary_cross_entropy",pretrainedfolder=None,
                 n_classes_pretrained=None,gradual_unfreezing=True,discriminative_lrs=True,
                 epochs_finetuning=30,early_stopping=None,
