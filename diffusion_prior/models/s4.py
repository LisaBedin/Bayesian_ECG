...
class SSKernelNPLR(OptimModule):
    ...
    def _step_state_linear(self, u=None, state=None):
        ...
        if state.size(-1) == self.N: # Only store half of the conjugate pairs; should be true by default
            ...
            #  worth setting up a contract_expression in default_state if we want to use this at inference time for stepping
...
class SSKernelDiag(OptimModule):
    ...
    def __init__(
        ...
        # Broadcast everything to correct shapes #  necessary?
